...
public class QueryUtil {
	...
	//////////////// Student Section////////////////
	public static final String CREATE_STUDENT = "insert into student_details(student_name, college_name, roll, dob, gender, subject, departments, email, image_url)values(?,?,?,?,?,?,?,?,?)";
	public static final String GET_ALL_STUDENT = "select * from student_details";
	...
	public static final String GET_IMAGE_URL_BY_ID = "select image_url from student_details where id=?";
	//////////////// User Section////////////////
